...
public class WorkToAddServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public WorkToAddServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.setContentType("trext/html;charset=utf-8");
		...
		//转发至显示页面
		RequestDispatcher rd = request.getRequestDispatcher("work_add.jsp");
